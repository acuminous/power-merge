...
describe('matches command', () => {
  ...
  it('should test facts with regex', () => {
    ...
    assert.strictEqual(cmd({ a: { value: 1 } }), true);
    assert.strictEqual(cmd({ a: { value: 11 } }), false);
  });
