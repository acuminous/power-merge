...
describe('matches command', function() {
    ...
    it('should test facts with regex', function() {
        ...
        assert.equal(cmd(context, { a: { value: 11 } }), false)
    })
